...
public class GenerateDataFileBadanUsaha {
...
//        sb.setLength(sb.length() - 1);
        ...
        String[] excelData = {"123","111"};
        String[] simpleArr = new String[data.size()];
        data.toArray(simpleArr);
        for (int i = 0; i < excelData.length; i++)
            sb.append(excelData[i]);
