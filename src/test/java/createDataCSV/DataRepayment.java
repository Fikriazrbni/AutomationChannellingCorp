...
import randomValue.GenerateRandomDataRepayment;
...
public class DataRepayment {
    private String pthResultDataDummyFile = Const.resultDataDummyFile;
    ArrayList<String[]> arrayData = new ArrayList<>();
    String jW;

    public void dataDummy(String case1, String case2, String case3, String input_jumlah_data) throws IOException {
...
//        jumlahData                        = input_jumlah_data;
        ...
        File fileRepay                     = new File(pthResultDataDummyFile + case3 + Const.extCSV);

        try {
            // create FileWriter object with file as parameter
            FileWriter outputfileApp     = new FileWriter(fileApp);
            FileWriter outputfileRea     = new FileWriter(fileRea);
            FileWriter outputfileRepay   = new FileWriter(fileRepay);
            ...
            CSVWriter writerRepay        = new CSVWriter(outputfileRepay, '|', CSVWriter.NO_QUOTE_CHARACTER, CSVWriter.DEFAULT_ESCAPE_CHARACTER, CSVWriter.DEFAULT_LINE_END);
            ...
            List<String[]> dataRepay  = new ArrayList<>();
            dataRepay.add(new String[]{
                    "Nomor_Aplikasi",
                    "Nomor_Pembayaran",
                    "Tanggal_Pembayaran",
                    "Nominal_Pokok",
...
//                            "2", generateRandomDataRea.cd_sektorEkonomi(environment), "00000010000000000", "1", "S125012529L", "000002300000000", "18", "Jakarta Selatan"});
            ...
            //write data csv repayment
            GenerateRandomDataRepayment grr = new GenerateRandomDataRepayment();
            arrayData = dataApp;
            for (String[] repayData : arrayData) {
                int i = 0;
                for (i = 7; i <= repayData.length; i++ ){
                    dataRepay.add(new String[]{
                            repayData[0], grr.noBayar(15), grr.tglBayar(), grr.nomPokok("000000004775800"),
                            grr.nomBunga("000000004775800"), grr.nomDenda("000000004775800"),
                            "N", grr.addInterest("000000004775800")
                    });
                }
            }
            ...
            writerRepay.writeAll(dataRepay);
            // closing writer connection
            writerRepay.close();
            writerApp.close();
            writerRea.close();
...
//                            "2", generateRandomDataRea.cd_sektorEkonomi(environment), "00000010000000000", "1", "S125012529L", "000002300000000", "18", "Jakarta Selatan"});
    ...
    public static void main(String[] args) throws IOException {
        ...
        clean.dltDummyExist();
        DataRepayment csv = new DataRepayment();
        csv.dataDummy(Const.appFile, Const.reaFile,Const.repayFile ,"8");
    }
}
