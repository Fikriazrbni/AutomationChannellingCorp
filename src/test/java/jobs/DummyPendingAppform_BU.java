...
public class DummyPendingAppform_BU {
...
//        String uat_pathFileIDV = "/cd/nasbdb/LOS_UAT/co-borrowing/approvalfile/appfile-source/";
        ...
        try {
            DummyPendingAppform_BU.hit_job = hit_job;
            ...
            for (int i = 0; i < listOfFiles.length; i++) {
                if (listOfFiles[i].isFile()) {
                    ...
                    if (listOfFiles[i].getName().contains("APPFILE")) {
                        ...
                        channelSftp.put(Const.resultDataDummyFilePending + getName, pthApprovalFile + listOfFiles[i].getName());
                        if (readTestData.environment.equals("E2E")) {
            ...
            System.out.println("====================================================");
            System.out.println("File list in server machine : " + getName);
