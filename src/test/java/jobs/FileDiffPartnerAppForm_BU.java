...
public class FileDiffPartnerAppForm_BU {
    ...
    public void serverAkses() {
        ...
        try {
            FileDiffPartnerAppForm_BU.hit_job = hit_job;
            ...
            File folder = new File(Const.resultApprovalFileDiffPartner); //resultDataDummyFile
            ...
            for (int i = 0; i < listOfFiles.length; i++) {
                if (listOfFiles[i].isFile()) {
                    ...
                    if (listOfFiles[i].getName().contains("APPFILE")) {
                        ...
                        channelSftp.put(Const.resultApprovalFileDiffPartner + getName, pthApprovalFile + listOfFiles[i].getName());
                        if (readTestData.environment.equals("E2E")) {
