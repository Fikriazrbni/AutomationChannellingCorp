...
public class DummyPendingReaForm_BU {
    ...
    public void serverAkses() {
        ...
        try {
            DummyPendingReaForm_BU.hit_job = hit_job;
            ...
            for (int i = 0; i < listOfFiles.length; i++) {
                if (listOfFiles[i].isFile()) {
                    ...
                    if (listOfFiles[i].getName().contains("REAFILE")) {
                        ...
                        channelSftp.put(Const.resultDataDummyFilePending + getName, pthBUFile + listOfFiles[i].getName());
                        if (readTestData.environment.equals("E2E")) {
                        ...
                        channelSftp.put(Const.resultDataDummyFilePending + getName2, pthPengurusFile + listOfFiles[i].getName());
                        if (readTestData.environment.equals("E2E")) {
