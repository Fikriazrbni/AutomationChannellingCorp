...
public class DummyReaForm_BU {
    ...
    public void serverAkses() {
        ...
        try {
            DummyReaForm_BU.hit_job = hit_job;
            ...
            File folder     = new File(Const.resultDataDummyFile); //resultDataDummyFile
            ...
            for (int i = 0; i < listOfFiles.length; i++) {
                if (listOfFiles[i].isFile()) {
                    ...
                    if (listOfFiles[i].getName().contains("REAFILE")) {
                        ...
                        channelSftp.put(Const.resultDataDummyFile + getName, pthBUFile + listOfFiles[i].getName()); //resultDataDummyFile
                        if (readTestData.environment.equals("E2E")) {
                        ...
                        channelSftp.put(Const.resultDataDummyFile + getName2, pthPengurusFile + listOfFiles[i].getName()); //resultDataDummyFile
                        if (readTestData.environment.equals("E2E")) {
