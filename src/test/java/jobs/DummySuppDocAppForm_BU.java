...
public class DummySuppDocAppForm_BU {

    static String user = "qalos";//qalos applos
    static String pass = "P@ssw0rd"; //password
    ReadTestData readTestData = new ReadTestData();
    public static String hit_job;
    static String getName = null;

    public void serverAkses(String noApplication) {
        ...
        try {
            DummySuppDocAppForm_BU.hit_job = hit_job;
            ...
            File folder = new File("./dummy_SuppDoc/");
            ...
            for (int i = 0; i < Objects.requireNonNull(listOfFiles).length; i++) {
                if (listOfFiles[i].isFile()) {
                    ...
                    if (listOfFiles[i].getName().contains(noApplication)) {
                        getName = listOfFiles[i].getName();
                        channelSftp.put("./dummy_SuppDoc/" + getName, pthApprovalFile + listOfFiles[i].getName());
                        if (readTestData.environment.equals("E2E")) {
